...
from skrl.agents.ppo import MBPO_PPO
from skrl.envs.wrappers import Wrapper
from skrl.trainers import Trainer
from skrl.trainers import IsaaclabTrainer


# fmt: off
# [start-config-dict-torch]
MBPOTrainer_DEFAULT_CONFIG = {
...
class MBPOTrainer(IsaaclabTrainer):
    ...
    def __init__(
        ...
        :param cfg: Configuration dictionary (default: ``None``).
                    See MBPOTrainer for default values
        :type cfg: dict, optional
        """
        _cfg = copy.deepcopy(MBPOTrainer_DEFAULT_CONFIG)
