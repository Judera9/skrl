...
from skrl.resources.schedulers import KLAdaptiveLR, ConstantScheduler, CosineScheduler  # noqa
...
class Runner:
    ...
    def _component(self, name: str) -> Type:
        ...
        if name == "gaussianmixin":
            from skrl.utils.model_instantiators import gaussian_model as component
        elif name == "categoricalmixin":
            from skrl.utils.model_instantiators import categorical_model as component
        elif name == "multicategoricalmixin":
            from skrl.utils.model_instantiators import multicategorical_model as component
        elif name == "deterministicmixin":
            from skrl.utils.model_instantiators import deterministic_model as component
        elif name == "multivariategaussianmixin":
            from skrl.utils.model_instantiators import multivariate_gaussian_model as component
        elif name == "shared":
            from skrl.utils.model_instantiators import shared_model as component
        ...
        # agent
            ...
            from skrl.agents.amp import AMP, AMP_DEFAULT_CONFIG

            component = AMP_DEFAULT_CONFIG if "default_config" in name else AMP
        elif name in ["cem", "cem_default_config"]:
            from skrl.agents.cem import CEM, CEM_DEFAULT_CONFIG
    ...
    def _process_cfg(self, cfg: dict) -> dict:
        ...
        _scheduler_pattern = re.compile(r".*scheduler$")
            ...
            for key, value in d.items():
                if isinstance(value, dict):
                    ...
                    if key in _direct_eval \
                        ...
                        or _scheduler_pattern.match(key):
